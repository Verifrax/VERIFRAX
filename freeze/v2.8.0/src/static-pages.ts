...
<body>
  <h1>VERIFRAX</h1>
  <p><strong>Execution engine:</strong> v2.7.0 (frozen) | <strong>Discovery & routing layer:</strong> v2.8.0 | <strong>State:</strong> Frozen | <strong>Mode:</strong> Deterministic · Non-Interpretive · Irreversible</p>
  <nav>
...
<body>
  ...
  <p><strong>Execution engine:</strong> v2.7.0 (frozen) | <strong>Discovery & routing layer:</strong> v2.8.0</p>
    ...
    "offers": [
      {
        ...
        "priceCurrency": "EUR",
        "price": "650",
        "name": "Tier A - Public Deterministic Verification",
        "availability": "https://schema.org/InStock"
      },
      {
        "@type": "Offer",
        "priceCurrency": "EUR",
        "price": "1500",
        "name": "Tier B - Priority Deterministic Verification",
        "availability": "https://schema.org/InStock"
      }
    ]
  }
...
<body>
  ...
  '/not-a-certificate-authority': `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>VERIFRAX — Not a Certificate Authority</title>
  <style>
    body { font-family: system-ui, sans-serif; max-width: 800px; margin: 0 auto; padding: 2rem; line-height: 1.6; }
    h1 { border-bottom: 2px solid #000; padding-bottom: 0.5rem; }
    .negative { background: #fee; padding: 1rem; margin: 1rem 0; border-left: 4px solid #c00; }
  </style>
</head>
<body>
  <h1>VERIFRAX Is Not a Certificate Authority</h1>
  <div class="negative">
    <p><strong>VERIFRAX is not a Certificate Authority (CA).</strong></p>
    <p>VERIFRAX is not a Public Key Infrastructure (PKI) service.</p>
    <p>VERIFRAX does not issue identity certificates, SSL/TLS certificates, or authentication certificates.</p>
    <p>VERIFRAX does not delegate trust or establish identity.</p>
    <p>VERIFRAX does not participate in blockchain consensus or distributed ledger systems.</p>
  </div>
  <p><a href="/">← Back to Home</a></p>
</body>
</html>`,

  '/use-cases/legal-deadline': `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Legal Deadline Finalization — VERIFRAX</title>
  <style>
    body { font-family: system-ui, sans-serif; max-width: 800px; margin: 0 auto; padding: 2rem; line-height: 1.6; }
    h1 { border-bottom: 2px solid #000; padding-bottom: 0.5rem; }
    .pain { background: #fee; padding: 1rem; margin: 1rem 0; border-left: 4px solid #c00; }
    .procedure { background: #f5f5f5; padding: 1rem; margin: 1rem 0; border-left: 4px solid #000; }
    button { background: #000; color: #fff; padding: 0.75rem 2rem; border: none; cursor: pointer; font-size: 1rem; margin: 1rem 0; }
    button:hover { background: #333; }
  </style>
</head>
<body>
  <h1>Legal Deadline Finalization</h1>
  <div class="pain">
    <p><strong>Pain:</strong> Evidence must be frozen before a court deadline. If this is wrong, the deadline fails.</p>
  </div>
  <p><strong>Allowed action:</strong> One execution → one certificate. No retries. No interpretation.</p>
  <p><strong>Disallowed action:</strong> No truth verification. No advice. No interpretation.</p>
  <div class="procedure">
    <h2>Procedure</h2>
    <ol>
      <li>Prepare evidence bundle</li>
      <li>Complete payment and obtain execution token</li>
      <li>Execute verification to receive immutable certificate</li>
    </ol>
  </div>
  <a href="/verify"><button>Execute Verification</button></a>
  <p><a href="/">← Back to Home</a></p>
</body>
</html>`,

  '/use-cases/evidence-fixation': `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Evidence Fixation — VERIFRAX</title>
  <style>
    body { font-family: system-ui, sans-serif; max-width: 800px; margin: 0 auto; padding: 2rem; line-height: 1.6; }
    h1 { border-bottom: 2px solid #000; padding-bottom: 0.5rem; }
    .pain { background: #fee; padding: 1rem; margin: 1rem 0; border-left: 4px solid #c00; }
...
<body>
  <h1>Evidence Fixation</h1>
  <div class="pain">
    <p><strong>Pain:</strong> Must prove a file existed at a specific time. If this is wrong, proof fails.</p>
  </div>
  <p><strong>Allowed action:</strong> One execution → one certificate. No retries. No interpretation.</p>
  <p><strong>Disallowed action:</strong> No truth verification. No advice. No interpretation.</p>
  <div class="procedure">
  ...
  '/use-cases/audit-finalization': `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Audit Finalization — VERIFRAX</title>
  <style>
    body { font-family: system-ui, sans-serif; max-width: 800px; margin: 0 auto; padding: 2rem; line-height: 1.6; }
    h1 { border-bottom: 2px solid #000; padding-bottom: 0.5rem; }
    .pain { background: #fee; padding: 1rem; margin: 1rem 0; border-left: 4px solid #c00; }
...
<body>
  <h1>Audit Finalization</h1>
  <div class="pain">
    <p><strong>Pain:</strong> Audit requires immutable verification certificate. If this is wrong, audit fails.</p>
  </div>
  <p><strong>Allowed action:</strong> One execution → one certificate. No retries. No interpretation.</p>
  <p><strong>Disallowed action:</strong> No truth verification. No advice. No interpretation.</p>
  <div class="procedure">
  ...
  '/use-cases/regulatory-lock': `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Regulatory Submission Lock — VERIFRAX</title>
  <style>
    body { font-family: system-ui, sans-serif; max-width: 800px; margin: 0 auto; padding: 2rem; line-height: 1.6; }
    h1 { border-bottom: 2px solid #000; padding-bottom: 0.5rem; }
    .pain { background: #fee; padding: 1rem; margin: 1rem 0; border-left: 4px solid #c00; }
...
<body>
  <h1>Regulatory Submission Lock</h1>
  <div class="pain">
    <p><strong>Pain:</strong> Regulatory submission requires evidence lock. If this is wrong, submission fails.</p>
  </div>
  <p><strong>Allowed action:</strong> One execution → one certificate. No retries. No interpretation.</p>
  <p><strong>Disallowed action:</strong> No truth verification. No advice. No interpretation.</p>
  <div class="procedure">
  ...
  '/use-cases/forensic-deadline': `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Forensic Deadline — VERIFRAX</title>
  <style>
    body { font-family: system-ui, sans-serif; max-width: 800px; margin: 0 auto; padding: 2rem; line-height: 1.6; }
    h1 { border-bottom: 2px solid #000; padding-bottom: 0.5rem; }
    .pain { background: #fee; padding: 1rem; margin: 1rem 0; border-left: 4px solid #c00; }
...
<body>
  <h1>Forensic Verification with Deadline</h1>
  <div class="pain">
    <p><strong>Pain:</strong> Forensic verification must be completed before deadline. If this is wrong, deadline fails.</p>
  </div>
  <p><strong>Allowed action:</strong> One execution → one certificate. No retries. No interpretation.</p>
  <p><strong>Disallowed action:</strong> No truth verification. No advice. No interpretation.</p>
  <div class="procedure">
  ...
  '/use-cases/ip-priority-proof': `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>IP Priority Proof — VERIFRAX</title>
  <style>
    body { font-family: system-ui, sans-serif; max-width: 800px; margin: 0 auto; padding: 2rem; line-height: 1.6; }
    h1 { border-bottom: 2px solid #000; padding-bottom: 0.5rem; }
    .pain { background: #fee; padding: 1rem; margin: 1rem 0; border-left: 4px solid #c00; }
...
<body>
  <h1>IP Priority Proof</h1>
  <div class="pain">
    <p><strong>Pain:</strong> Intellectual property priority requires timestamped proof. If this is wrong, priority fails.</p>
  </div>
  <p><strong>Allowed action:</strong> One execution → one certificate. No retries. No interpretation.</p>
  <p><strong>Disallowed action:</strong> No truth verification. No advice. No interpretation.</p>
  <div class="procedure">
